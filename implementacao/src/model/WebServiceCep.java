...
public final class WebServiceCep {
	 ...
	 * um Iterable, para ser usado dentro de um for.
	 * 
	 * @see Iterable
	 * @see Iterator
	 * @author Tomaz Lavieri
	...
	/**
	 * Classe contendo todos os Enums {@link Xml}. Tem como finalidade, buscar um
	 * Enumeration especifico pelo seu nome.
	 * 
	 * @author Tomaz Lavieri
	 */
	 ...
	 * @throws DocumentException     Quando h� problema na forma��o do
	 *                               documento XML.
	 ...
	 * para <tt>"14555168"</tt>, s� levando em conta os primeiros 8 n�meros.
	 * 
	 * @param cep N�mero do cep a ser carregado. S� ser�o considerados os
	 *            primeiros 8 n�meros da {@link String} enviada. Todos os
	 *            caracters n�o num�ricos ser�o removidos, e a string ser�
